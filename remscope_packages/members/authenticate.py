...
def fill_input_pin(skicall):
    ...
    rnd1, rnd2 = redis_ops.two_min_numbers(1, skicall.proj_data.get("rconn_0"), skicall.proj_data.get("rconn"))
    if rnd1 is None:
...
def check_pin(skicall):
    ...
    try:
        ...
        try:
            ...
            raise FailPage(message = "Invalid input")
        rnd = redis_ops.two_min_numbers(1, skicall.proj_data.get("rconn_0"), skicall.proj_data.get("rconn"))
